...
> **Bản này thay bản v1.** v1 (`SHB-Digital-Expert-Agents-Solution-Design.md`) đóng khung quanh **tín dụng doanh nghiệp 20 tỷ**. Mentor đã chỉ hướng **khách hàng cá nhân** → kịch bản đó không còn dùng.
> **v1 giữ lại làm tham chiếu**, không xoá: §5 kiến trúc, §7 kiểm soát, §2.4 hiện trạng SHB, Phụ lục F nguồn — vẫn đúng và được dẫn lại ở đây.
...
| Thay v1 ở | Kịch bản, §4, §12 · **không** thay kiến trúc |
...
Giữ nguyên từ v1 §2.4 (nguồn ở v1 Phụ lục F). Bản rút gọn:
...
| **RPA — WinActor** | Đã thử nghiệm | *"Chúng tôi không thay WinActor. Chúng tôi cho nó biết phải làm gì."* RPA là tay, agent là đầu. Xem v1 §2.4.2 |
...
v1 tránh được mũi này vì đứng ở doanh nghiệp. **v2 đứng đúng giữa sân đó.** Câu *"cái này scorecard/LOS làm rồi"* sẽ tới trong 60 giây đầu. Phải có đáp án **trước khi viết dòng code nào**.
...
- **Hệ RBAC cấp sản xuất.** ⚠️ *Khác v1:* cấm là cấm **hệ thật**. **Cơ chế** MCP phân role thì demo — mentor coi đây là chuyện lõi (§6.6).
...
> **Cảnh báo thật.** v1 §4.2 nghiên cứu quy trình tín dụng **doanh nghiệp** — bốn phòng ban, hai báo cáo độc lập. **Bán lẻ mỏng hơn và tôi chưa nghiên cứu nó.** Mục này là hình dạng chung suy ra, chưa có nguồn.
...
### 7.6 Responsible AI — mentor nhắc, v1 không có
...
## 8. Chi phí & break-even — v1 không có mục này
...
| 4 | **Model** — `AGENTS.md` §3 khoá `gpt-4o-mini` | Cả team, **giờ 0** | `gpt-4o-mini` làm Planner là yếu: nó phải phân rã DAG **và** nuốt veto rồi lập lại kế hoạch. Đổi stack = quyết định team |
...
- **v2 thay v1 ở kịch bản, không ở kiến trúc.** v1 giữ nguyên: §2.4 hiện trạng SHB (đầy đủ hơn), §2.4.2 RPA, §2.4.3 SHBFinance, §3.3 bản đồ quy trình, Phụ lục F nguồn.
